...
void initialize_radio()
{
   ...
   */
const char *devAddr = "26011D3B";
const char *nwkSKey = "7635A4BE977157D3C267FB33D5E135B2";
const char *appSKey = "ED9C30106ACE3575C81FF6F77C5ACF5C";
...
void loop()
{
    ...
    Serial.println(sensorValue_f,DEC);
    myLora.tx((String)sensorValue); //one byte, blocking function
    led_off();
    delay(200);
}
